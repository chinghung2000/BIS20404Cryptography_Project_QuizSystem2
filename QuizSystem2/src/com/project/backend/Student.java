...
public class Student extends User implements StudentInterface {
	...
	public Student(ResultSet rs) {
		try {
			...
			System.out.println("Student: There is an error: " + e.toString());
		}
	}
	...
	public Submission getSubmission(int taskId, String studentId) {
		...
		db.prepare(
				"SELECT sn.submission_id, sn.task_id, s.student_id, s.student_name, sn.submission_file_name, sn.submission_file_hash FROM submission sn INNER JOIN student s ON sn.student_id = s.student_id WHERE sn.task_id = ? AND sn.student_id = ?;",
				taskId, studentId);
		ResultSet rs = db.executeQuery();
	...
	public int addSubmission(int taskId, String studentId, String fileName) {
		...
		db.prepareForGeneratedKey(
				"INSERT INTO submission (task_id, student_id, submission_file_name, submission_file_hash) VALUES (?, ?, ?, '');",
